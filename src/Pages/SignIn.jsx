              ...
              <form onSubmit={ handleSignin} className="space-y-5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    name="password"
                    placeholder="••••••••"
                    className="input input-bordered w-full bg-white text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  />
                  <span
                    onClick={() => setShow(!show)}
                    className="absolute right-[8px] top-[36px] cursor-pointer z-50 "
                  >
                    {show ? <FaEye className="opacity-100 "/> : <IoEyeOff />}
                  </span>
                </div>
